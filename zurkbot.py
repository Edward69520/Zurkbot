...
if ENV:
    ...
    GIT_REPO_URL = environ.get('GIT_REPO_URL', "https://github.com/Edward69520/zurkbot")
...
print("If you need more help, join @cruzih4ck5 in Telegram.")
...
def support(_bot, update):
    ...
    message.reply_text(
        ...
        f"*Getting Support*\n\nTo get support in using the bot, join [the zurkbot support](https://t.me/cruzih4ck5).",
...
def source(_bot, update):
    ...
    message.reply_text(
        ...
        f"*Source*:\n[zurkbot Repo](https://github.com/Edward69520/zurkbot:).",
